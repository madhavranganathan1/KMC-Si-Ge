...
void my_dfthomas (const gsl_vector *v, void *params,gsl_vector *df)
{
	    ...
	    *  So, we will start with the Fourier modes and then start calculating each of the derivatives */
		...
		for (In = 0; In < Nx; In++ ) {
			...
			for (J=0; J < Ny ; J++) {
				...
				/*	if (disTy[In][J][K].Type == 0) {
					...
					*/
					...
					if ((disTy[In][J][K].Type == 1) && (disTy[Iprev][J][K].Type == 1)) {
						...
						xder += kspringLAA * (disTy[In][J][K].xdisp -disTy[Iprev][J][K].xdisp);
						...
						xder += kspringLBB * (disTy[In][J][K].xdisp -disTy[Iprev][J][K].xdisp) ;
	                   					
					} 
					else if ( ((disTy[In][J][K].Type == 1) && (disTy[Iprev][J][K].Type == 2)) || ((disTy[In][J][K].Type == 1) && (disTy[Iprev][J][K].Type == 2)) ){
						
						xder += kspringLAB * (disTy[In][J][K].xdisp -disTy[Iprev][J][K].xdisp) ;
					...
					xder += kspringLAA *  (disTy[In][J][K].xdisp -disTy[Inext][J][K].xdisp);
					   					}
					
					else if  ((disTy[In][J][K].Type == 2) && (disTy[Inext][J][K].Type == 2)) {
						xder += kspringLBB *  (disTy[In][J][K].xdisp -disTy[Inext][J][K].xdisp);
											}
					
					else if (((disTy[In][J][K].Type == 1) && (disTy[Inext][J][K].Type == 2))  || ((disTy[In][J][K].Type == 1) && (disTy[Inext][J][K].Type == 2)) ) {
					   xder += kspringLAB * (disTy[In][J][K].xdisp -disTy[Inext][J][K].xdisp);
					   					}  
					...
					if ((disTy[In][J][K].Type == 1) && (disTy[In][Jprev][K].Type == 1)) {
					 ...
					 yder += kspringLAA *(disTy[In][J][K].ydisp -disTy[In][Jprev][K].ydisp);
					   
					
					}
					else if  ((disTy[In][J][K].Type == 2) && (disTy[In][Jprev][K].Type == 2)) {
						   yder += kspringLBB *(disTy[In][J][K].ydisp -disTy[In][Jprev][K].ydisp);

											} 
					else if ( ((disTy[In][J][K].Type == 1) && (disTy[In][Jprev][K].Type == 2)) || ((disTy[In][J][K].Type == 1) && (disTy[In][Jprev][K].Type == 2)) ){
						  yder += kspringLAB *(disTy[In][J][K].ydisp -disTy[In][Jprev][K].ydisp);
					...
					yder += kspringLAA *  (disTy[In][J][K].ydisp -disTy[In][Jnext][K].ydisp ) ;
					 					}
					else if  ((disTy[In][J][K].Type == 2) && (disTy[In][Jnext][K].Type == 2)) {
					yder += kspringLBB *  (disTy[In][J][K].ydisp -disTy[In][Jnext][K].ydisp ) ;
	} 
					else if ( ((disTy[In][J][K].Type == 1) && (disTy[In][Jnext][K].Type == 2)) || ((disTy[In][J][K].Type == 1) && (disTy[In][Jnext][K].Type == 2)) ){
						
					yder += kspringLAB *  (disTy[In][J][K].ydisp -disTy[In][Jnext][K].ydisp ) ;
					}        
					...
					zder += kspringLAA *(disTy[In][J][K].zdisp -disTy[In][J][Kprev].zdisp);
					
					}
					else if  ((disTy[In][J][K].Type == 2) && (disTy[In][J][Kprev].Type == 2)) {
				    
					zder += kspringLBB *(disTy[In][J][K].zdisp -disTy[In][J][Kprev].zdisp);

										
					} 
					else if ( ((disTy[In][J][K].Type == 1) && (disTy[In][J][Kprev].Type == 2)) || ((disTy[In][J][K].Type == 1) && (disTy[In][J][Kprev].Type == 2)) ){
					zder += kspringLAB *(disTy[In][J][K].zdisp -disTy[In][J][Kprev].zdisp);
											}  
				    ...
				    if ((disTy[In][J][K].Type == 1) && (disTy[In][J][Knext].Type == 1)) {
					    ...
					    zder += kspringLAA *(disTy[In][J][K].zdisp -disTy[In][J][Knext].zdisp);
					
					}
					else if  ((disTy[In][J][K].Type == 2) && (disTy[In][J][Knext].Type == 2)) {
						 zder += kspringLBB *(disTy[In][J][K].zdisp -disTy[In][J][Knext].zdisp);
						 
											
					} 
					else if ( ((disTy[In][J][K].Type == 1) && (disTy[In][J][Knext].Type == 2)) || ((disTy[In][J][K].Type == 1) && (disTy[In][J][Knext].Type == 2)) ){
						 zder += kspringLAB *(disTy[In][J][K].zdisp -disTy[In][J][Knext].zdisp);
					...
					if ((disTy[In][J][K].Type == 1) && (disTy[In][Jprev][Kprev].Type == 1)) {
						...
						yder += 0.5*kspringDAA * (disTy[In][J][K].ydisp -disTy[In][Jprev][Kprev].ydisp )+0.5*kspringDAA * (disTy[In][J][K].zdisp -disTy[In][Jprev][Kprev].zdisp );
					    zder += 0.5*kspringDAA * (disTy[In][J][K].zdisp -disTy[In][Jprev][Kprev].zdisp )+0.5*kspringDAA * (disTy[In][J][K].ydisp -disTy[In][Jprev][Kprev].ydisp );
						
					
					}
					else if  ((disTy[In][J][K].Type == 2) && (disTy[In][Jprev][Kprev].Type == 2)) {
					    yder += 0.5*kspringDBB * (disTy[In][J][K].ydisp -disTy[In][Jprev][Kprev].ydisp )+0.5*kspringDBB * (disTy[In][J][K].zdisp -disTy[In][Jprev][Kprev].zdisp );
					    zder += 0.5*kspringDBB * (disTy[In][J][K].zdisp -disTy[In][Jprev][Kprev].zdisp )+0.5*kspringDBB * (disTy[In][J][K].ydisp -disTy[In][Jprev][Kprev].ydisp );
						...
						yder += 0.5*kspringDAB *(disTy[In][J][K].ydisp -disTy[In][Jprev][Kprev].ydisp )+0.5*kspringDAB * (disTy[In][J][K].zdisp -disTy[In][Jprev][Kprev].zdisp );
					    zder += 0.5*kspringDAB *(disTy[In][J][K].zdisp -disTy[In][Jprev][Kprev].zdisp )+0.5*kspringDAB * (disTy[In][J][K].ydisp -disTy[In][Jprev][Kprev].ydisp );
					...
					if ((disTy[In][J][K].Type == 1) && (disTy[In][Jprev][Knext].Type == 1)) {
					    ...
					    yder += 0.5*kspringDAA * (disTy[In][J][K].ydisp -disTy[In][Jprev][Knext].ydisp)-0.5*kspringDAA * (disTy[In][J][K].zdisp -disTy[In][Jprev][Knext].zdisp);
					    zder +=-(0.5*kspringDAA * (disTy[In][J][K].ydisp -disTy[In][Jprev][Knext].ydisp)-0.5*kspringDAA * (disTy[In][J][K].zdisp -disTy[In][Jprev][Knext].zdisp));
					
					
					}
					else if  ((disTy[In][J][K].Type == 2) && (disTy[In][Jprev][Knext].Type == 2)) {
						
					    yder += 0.5*kspringDBB * (disTy[In][J][K].ydisp -disTy[In][Jprev][Knext].ydisp)-0.5*kspringDBB * (disTy[In][J][K].zdisp -disTy[In][Jprev][Knext].zdisp);
					    zder +=-(0.5*kspringDBB * (disTy[In][J][K].ydisp -disTy[In][Jprev][Knext].ydisp)-0.5*kspringDBB * (disTy[In][J][K].zdisp -disTy[In][Jprev][Knext].zdisp));
					    ...
					    yder += 0.5*kspringDAB * (disTy[In][J][K].ydisp -disTy[In][Jprev][Knext].ydisp)-0.5*kspringDAB * (disTy[In][J][K].zdisp -disTy[In][Jprev][Knext].zdisp);
					    zder +=-(0.5*kspringDAB * (disTy[In][J][K].ydisp -disTy[In][Jprev][Knext].ydisp)-0.5*kspringDAB * (disTy[In][J][K].zdisp -disTy[In][Jprev][Knext].zdisp));
					...
					yder += -(-0.5*kspringDAA *(disTy[In][J][K].ydisp -disTy[In][Jnext][Kprev].ydisp)+0.5*kspringDAA *(disTy[In][J][K].zdisp -disTy[In][Jnext][Kprev].zdisp));
					zder += -0.5*kspringDAA *(disTy[In][J][K].ydisp -disTy[In][Jnext][Kprev].ydisp)+0.5*kspringDAA*(disTy[In][J][K].zdisp -disTy[In][Jnext][Kprev].zdisp);


					   					}
					else if  ((disTy[In][J][K].Type == 2) && (disTy[In][Jnext][Kprev].Type == 2)) {
					yder += -(-0.5*kspringDBB *(disTy[In][J][K].ydisp -disTy[In][Jnext][Kprev].ydisp)+0.5*kspringDBB *(disTy[In][J][K].zdisp -disTy[In][Jnext][Kprev].zdisp));
					zder += -0.5*kspringDBB *(disTy[In][J][K].ydisp -disTy[In][Jnext][Kprev].ydisp)+0.5*kspringDBB *(disTy[In][J][K].zdisp -disTy[In][Jnext][Kprev].zdisp);


																	} 
					else if ( ((disTy[In][J][K].Type == 1) && (disTy[In][Jnext][Kprev].Type == 2)) || ((disTy[In][J][K].Type == 1) && (disTy[In][Jnext][Kprev].Type == 2)) ){
					yder += -(-0.5*kspringDAB *(disTy[In][J][K].ydisp -disTy[In][Jnext][Kprev].ydisp)+0.5*kspringDAB *(disTy[In][J][K].zdisp -disTy[In][Jnext][Kprev].zdisp));
					zder += -0.5*kspringDAB *(disTy[In][J][K].ydisp -disTy[In][Jnext][Kprev].ydisp)+0.5*kspringDAB *(disTy[In][J][K].zdisp -disTy[In][Jnext][Kprev].zdisp);
					...
					if ((disTy[In][J][K].Type == 1) && (disTy[In][Jnext][Knext].Type == 1)) {
					    ...
					    yder +=-(- 0.5*kspringDAA * (disTy[In][J][K].ydisp -disTy[In][Jnext][Knext].ydisp )-0.5*kspringDAA * (disTy[In][J][K].zdisp -disTy[In][Jnext][Knext].zdisp ));
					    zder += -(-0.5*kspringDAA * (disTy[In][J][K].ydisp -disTy[In][Jnext][Knext].ydisp )-0.5*kspringDAA * (disTy[In][J][K].zdisp -disTy[In][Jnext][Knext].zdisp ));
					
					}
					else if  ((disTy[In][J][K].Type == 2) && (disTy[In][Jnext][Knext].Type == 2)) {
					 
						yder +=-(- 0.5*kspringDBB * (disTy[In][J][K].ydisp -disTy[In][Jnext][Knext].ydisp )-0.5*kspringDBB * (disTy[In][J][K].zdisp -disTy[In][Jnext][Knext].zdisp ));
					    zder += -(-0.5*kspringDBB * (disTy[In][J][K].ydisp -disTy[In][Jnext][Knext].ydisp )-0.5*kspringDBB * (disTy[In][J][K].zdisp -disTy[In][Jnext][Knext].zdisp ));
					

					} 
					else if ( ((disTy[In][J][K].Type == 1) && (disTy[In][Jnext][Knext].Type == 2)) || ((disTy[In][J][K].Type == 1) && (disTy[In][Jnext][Knext].Type == 2)) ){
						
					yder +=-(- 0.5*kspringDAB * (disTy[In][J][K].ydisp -disTy[In][Jnext][Knext].ydisp )-0.5*kspringDAB * (disTy[In][J][K].zdisp -disTy[In][Jnext][Knext].zdisp ));
					zder += -(-0.5*kspringDAB * (disTy[In][J][K].ydisp -disTy[In][Jnext][Knext].ydisp )-0.5*kspringDAB * (disTy[In][J][K].zdisp -disTy[In][Jnext][Knext].zdisp ));
					} 
					...
					if ((disTy[In][J][K].Type == 1) && (disTy[Iprev][J][Kprev].Type == 1)) {
						...
						xder += 0.5*kspringDAA*(disTy[In][J][K].xdisp -disTy[Iprev][J][Kprev].xdisp)+0.5*kspringDAA*(disTy[In][J][K].zdisp -disTy[Iprev][J][Kprev].zdisp);
					
					    zder += 0.5*kspringDAA*(disTy[In][J][K].xdisp -disTy[Iprev][J][Kprev].xdisp)+0.5*kspringDAA*(disTy[In][J][K].zdisp -disTy[Iprev][J][Kprev].zdisp);
					
	                    
					}
					else if  ((disTy[In][J][K].Type == 2) && (disTy[Iprev][J][Kprev].Type == 2)) {
						
						xder += 0.5*kspringDBB*(disTy[In][J][K].xdisp -disTy[Iprev][J][Kprev].xdisp)+0.5*kspringDBB*(disTy[In][J][K].zdisp -disTy[Iprev][J][Kprev].zdisp);
					
					    zder += 0.5*kspringDBB*(disTy[In][J][K].xdisp -disTy[Iprev][J][Kprev].xdisp)+0.5*kspringDBB*(disTy[In][J][K].zdisp -disTy[Iprev][J][Kprev].zdisp);
					
					} 
					else if ( ((disTy[In][J][K].Type == 1) && (disTy[Iprev][J][Kprev].Type == 2)) || ((disTy[In][J][K].Type == 1) && (disTy[Iprev][J][Kprev].Type == 2)) ){
						
						
						xder += 0.5*kspringDAB*(disTy[In][J][K].xdisp -disTy[Iprev][J][Kprev].xdisp)+0.5*kspringDAB*(disTy[In][J][K].zdisp -disTy[Iprev][J][Kprev].zdisp);
					
					    zder += 0.5*kspringDAB*(disTy[In][J][K].xdisp -disTy[Iprev][J][Kprev].xdisp)+0.5*kspringDAB*(disTy[In][J][K].zdisp -disTy[Iprev][J][Kprev].zdisp);
					...
					if ((disTy[In][J][K].Type == 1) && (disTy[Inext][J][Kprev].Type == 1)) {
					    ...
					    xder +=-(-0.5*kspringDAA*(disTy[In][J][K].xdisp -disTy[Inext][J][Kprev].xdisp)+0.5*kspringDAA*(disTy[In][J][K].zdisp -disTy[Inext][J][Kprev].zdisp));
						zder +=(-0.5*kspringDAA*(disTy[In][J][K].xdisp -disTy[Inext][J][Kprev].xdisp)+0.5*kspringDAA*(disTy[In][J][K].zdisp -disTy[Inext][J][Kprev].zdisp));
					
					}
					else if  ((disTy[In][J][K].Type == 2) && (disTy[Inext][J][Kprev].Type == 2)) {
					    xder +=-(-0.5*kspringDBB*(disTy[In][J][K].xdisp -disTy[Inext][J][Kprev].xdisp)+0.5*kspringDBB*(disTy[In][J][K].zdisp -disTy[Inext][J][Kprev].zdisp));
					    zder +=(-0.5*kspringDBB*(disTy[In][J][K].xdisp -disTy[Inext][J][Kprev].xdisp)+0.5*kspringDBB*(disTy[In][J][K].zdisp -disTy[Inext][J][Kprev].zdisp));
				...
				else if ( ((disTy[In][J][K].Type == 1) && (disTy[Inext][J][Kprev].Type == 2)) || ((disTy[In][J][K].Type == 1) && (disTy[Inext][J][Kprev].Type == 2)) ){
						xder +=-(-0.5*kspringDAB*(disTy[In][J][K].xdisp -disTy[Inext][J][Kprev].xdisp)+0.5*kspringDAB*(disTy[In][J][K].zdisp -disTy[Inext][J][Kprev].zdisp));
					    zder +=(-0.5*kspringDAB*(disTy[In][J][K].xdisp -disTy[Inext][J][Kprev].xdisp)+0.5*kspringDAB*(disTy[In][J][K].zdisp -disTy[Inext][J][Kprev].zdisp));
					...
					if ((disTy[In][J][K].Type == 1) && (disTy[Iprev][J][Knext].Type == 1)) {
					   ...
					   xder += 0.5*kspringDAA * (disTy[In][J][K].xdisp -disTy[Iprev][J][Knext].xdisp)-0.5*kspringDAA * (disTy[In][J][K].zdisp -disTy[Iprev][J][Knext].zdisp ) ;
					   zder +=-(0.5*kspringDAA * (disTy[In][J][K].xdisp -disTy[Iprev][J][Knext].xdisp)-0.5*kspringDAA * (disTy[In][J][K].zdisp -disTy[Iprev][J][Knext].zdisp )) ;
					
					}
					else if  ((disTy[In][J][K].Type == 2) && (disTy[Iprev][J][Knext].Type == 2)) {
					
					 
					   xder += 0.5*kspringDBB * (disTy[In][J][K].xdisp -disTy[Iprev][J][Knext].xdisp)-0.5*kspringDBB * (disTy[In][J][K].zdisp -disTy[Iprev][J][Knext].zdisp ) ;
					   zder +=-(0.5*kspringDBB * (disTy[In][J][K].xdisp -disTy[Iprev][J][Knext].xdisp)-0.5*kspringDBB * (disTy[In][J][K].zdisp -disTy[Iprev][J][Knext].zdisp )) ;
					   ...
					   xder += 0.5*kspringDAB * (disTy[In][J][K].xdisp -disTy[Iprev][J][Knext].xdisp)-0.5*kspringDAB * (disTy[In][J][K].zdisp -disTy[Iprev][J][Knext].zdisp ) ;
					   zder +=-(0.5*kspringDAB * (disTy[In][J][K].xdisp -disTy[Iprev][J][Knext].xdisp)-0.5*kspringDAB * (disTy[In][J][K].zdisp -disTy[Iprev][J][Knext].zdisp )) ;
					...
					if ((disTy[In][J][K].Type == 1) && (disTy[Inext][J][Knext].Type == 1)) {
						...
						xder += -(-0.5*kspringDAA * (disTy[In][J][K].xdisp -disTy[Inext][J][Knext].xdisp)- 0.5*kspringDAA * (disTy[In][J][K].zdisp -disTy[Inext][J][Knext].zdisp));
					 
					    zder +=   -0.5*kspringDAA * (disTy[In][J][K].xdisp -disTy[Inext][J][Knext].xdisp)- 0.5*kspringDAA * (disTy[In][J][K].zdisp -disTy[Inext][J][Knext].zdisp);
					
					}
					else if  ((disTy[In][J][K].Type == 2) && (disTy[Inext][J][Knext].Type == 2)) {
					
						xder += -(-0.5*kspringDBB * (disTy[In][J][K].xdisp -disTy[Inext][J][Knext].xdisp)- 0.5*kspringDBB * (disTy[In][J][K].zdisp -disTy[Inext][J][Knext].zdisp));
					 
					    zder +=   -0.5*kspringDBB * (disTy[In][J][K].xdisp -disTy[Inext][J][Knext].xdisp)- 0.5*kspringDBB * (disTy[In][J][K].zdisp -disTy[Inext][J][Knext].zdisp);
					

					
					} 
					else if ( ((disTy[In][J][K].Type == 1) && (disTy[Inext][J][Knext].Type == 2)) || ((disTy[In][J][K].Type == 1) && (disTy[Inext][J][Knext].Type == 2)) ){
						xder += -(-0.5*kspringDAB * (disTy[In][J][K].xdisp -disTy[Inext][J][Knext].xdisp)- 0.5*kspringDAB * (disTy[In][J][K].zdisp -disTy[Inext][J][Knext].zdisp));
					    zder +=   -0.5*kspringDAB * (disTy[In][J][K].xdisp -disTy[Inext][J][Knext].xdisp)- 0.5*kspringDAB * (disTy[In][J][K].zdisp -disTy[Inext][J][Knext].zdisp);
					...
					if ((disTy[In][J][K].Type == 1) && (disTy[Iprev][Jprev][K].Type == 1)) {
						...
						xder += 0.5*kspringDAA * (disTy[In][J][K].xdisp -disTy[Iprev][Jprev][K].xdisp ) +0.5*kspringDAA * (disTy[In][J][K].ydisp -disTy[Iprev][Jprev][K].ydisp );
					    yder += 0.5*kspringDAA * (disTy[In][J][K].xdisp -disTy[Iprev][Jprev][K].xdisp ) +0.5*kspringDAA * (disTy[In][J][K].ydisp -disTy[Iprev][Jprev][K].ydisp );
					  					}
					else if  ((disTy[In][J][K].Type == 2) && (disTy[Iprev][Jprev][K].Type == 2)) {
						xder += 0.5*kspringDBB * (disTy[In][J][K].xdisp -disTy[Iprev][Jprev][K].xdisp ) +0.5*kspringDBB * (disTy[In][J][K].ydisp -disTy[Iprev][Jprev][K].ydisp );
					    yder += 0.5*kspringDBB * (disTy[In][J][K].xdisp -disTy[Iprev][Jprev][K].xdisp ) +0.5*kspringDBB * (disTy[In][J][K].ydisp -disTy[Iprev][Jprev][K].ydisp );
					
											} 
					else if ( ((disTy[In][J][K].Type == 1) && (disTy[Iprev][Jprev][K].Type == 2)) || ((disTy[In][J][K].Type == 1) && (disTy[Iprev][Jprev][K].Type == 2)) ){
						
						xder += 0.5*kspringDAB * (disTy[In][J][K].xdisp -disTy[Iprev][Jprev][K].xdisp ) +0.5*kspringDAB * (disTy[In][J][K].ydisp -disTy[Iprev][Jprev][K].ydisp );
					    yder += 0.5*kspringDAB * (disTy[In][J][K].xdisp -disTy[Iprev][Jprev][K].xdisp ) +0.5*kspringDAB * (disTy[In][J][K].ydisp -disTy[Iprev][Jprev][K].ydisp );					}  
					
					/* Neighbour 16   */
					if ((disTy[In][J][K].Type == 1) && (disTy[Iprev][Jnext][K].Type == 1)) {
						
					xder += 0.5*kspringDAA *(disTy[In][J][K].xdisp -disTy[Iprev][Jnext][K].xdisp)-0.5*kspringDAA *(disTy[In][J][K].ydisp -disTy[Iprev][Jnext][K].ydisp );
					yder += -(0.5*kspringDAA *(disTy[In][J][K].xdisp -disTy[Iprev][Jnext][K].xdisp)-0.5*kspringDAA *(disTy[In][J][K].ydisp -disTy[Iprev][Jnext][K].ydisp ));
					 					
					}
					
					else if  ((disTy[In][J][K].Type == 2) && (disTy[Iprev][Jnext][K].Type == 2)) {
					xder += 0.5*kspringDBB *(disTy[In][J][K].xdisp -disTy[Iprev][Jnext][K].xdisp)-0.5*kspringDBB *(disTy[In][J][K].ydisp -disTy[Iprev][Jnext][K].ydisp );
					yder += -(0.5*kspringDBB *(disTy[In][J][K].xdisp -disTy[Iprev][Jnext][K].xdisp)-0.5*kspringDBB *(disTy[In][J][K].ydisp -disTy[Iprev][Jnext][K].ydisp ));
					...
					xder += 0.5*kspringDAB *(disTy[In][J][K].xdisp -disTy[Iprev][Jnext][K].xdisp)-0.5*kspringDAB *(disTy[In][J][K].ydisp -disTy[Iprev][Jnext][K].ydisp );
					yder += -(0.5*kspringDAB *(disTy[In][J][K].xdisp -disTy[Iprev][Jnext][K].xdisp)-0.5*kspringDAB *(disTy[In][J][K].ydisp -disTy[Iprev][Jnext][K].ydisp ));
					...
					if ((disTy[In][J][K].Type == 1) && (disTy[Inext][Jprev][K].Type == 1)) {
						...
						xder += -(-0.5*kspringDAA * (disTy[In][J][K].xdisp -disTy[Inext][Jprev][K].xdisp ) +0.5*kspringDAA *(disTy[In][J][K].ydisp -disTy[Inext][Jprev][K].ydisp ));
					    yder += -0.5*kspringDAA * (disTy[In][J][K].xdisp -disTy[Inext][Jprev][K].xdisp ) +0.5*kspringDAA *(disTy[In][J][K].ydisp -disTy[Inext][Jprev][K].ydisp ) ;
					   					
					}
					else if  ((disTy[In][J][K].Type == 2) && (disTy[Inext][Jprev][K].Type == 2)) {
						xder += -(-0.5*kspringDBB * (disTy[In][J][K].xdisp -disTy[Inext][Jprev][K].xdisp ) +0.5*kspringDBB*(disTy[In][J][K].ydisp -disTy[Inext][Jprev][K].ydisp ));
					    yder += -0.5*kspringDBB * (disTy[In][J][K].xdisp -disTy[Inext][Jprev][K].xdisp ) +0.5*kspringDBB*(disTy[In][J][K].ydisp -disTy[Inext][Jprev][K].ydisp ) ;
					   					

											
					} 
					else if ( ((disTy[In][J][K].Type == 1) && (disTy[Inext][Jprev][K].Type == 2)) || ((disTy[In][J][K].Type == 1) && (disTy[Inext][Jprev][K].Type == 2)) ){
				
					    xder += -(-0.5*kspringDAB* (disTy[In][J][K].xdisp -disTy[Inext][Jprev][K].xdisp ) +0.5*kspringDAB*(disTy[In][J][K].ydisp -disTy[Inext][Jprev][K].ydisp ));
					    yder += -0.5*kspringDAB* (disTy[In][J][K].xdisp -disTy[Inext][Jprev][K].xdisp ) +0.5*kspringDAB*(disTy[In][J][K].ydisp -disTy[Inext][Jprev][K].ydisp ) ;
	...
	/*				 Neighbour 18   */
					if ((disTy[In][J][K].Type == 1) && (disTy[Inext][Jnext][K].Type == 1)) {
						...
						xder += -(-0.5*kspringDAA * (disTy[In][J][K].xdisp -disTy[Inext][Jnext][K].xdisp )-0.5*kspringDAA * (disTy[In][J][K].ydisp -disTy[Inext][Jnext][K].ydisp ) );
					    yder += -(-0.5*kspringDAA * (disTy[In][J][K].xdisp -disTy[Inext][Jnext][K].xdisp )-0.5*kspringDAA * (disTy[In][J][K].ydisp -disTy[Inext][Jnext][K].ydisp ));
					 
					
					}
					else if  ((disTy[In][J][K].Type == 2) && (disTy[Inext][Jnext][K].Type == 2)) {
						xder += -(-0.5*kspringDBB * (disTy[In][J][K].xdisp -disTy[Inext][Jnext][K].xdisp )-0.5*kspringDBB * (disTy[In][J][K].ydisp -disTy[Inext][Jnext][K].ydisp ) );
					    yder += -(-0.5*kspringDBB * (disTy[In][J][K].xdisp -disTy[Inext][Jnext][K].xdisp )-0.5*kspringDBB * (disTy[In][J][K].ydisp -disTy[Inext][Jnext][K].ydisp ));
					...
					else if ( ((disTy[In][J][K].Type == 1) && (disTy[Inext][Jnext][K].Type == 2)) || ((disTy[In][J][K].Type == 1) && (disTy[Inext][Jnext][K].Type == 2)) ){
						
						xder += -(-0.5*kspringDAB * (disTy[In][J][K].xdisp -disTy[Inext][Jnext][K].xdisp )-0.5*kspringDAB * (disTy[In][J][K].ydisp -disTy[Inext][Jnext][K].ydisp ) );
					    yder += -(-0.5*kspringDAB * (disTy[In][J][K].xdisp -disTy[Inext][Jnext][K].xdisp )-0.5*kspringDAB * (disTy[In][J][K].ydisp -disTy[Inext][Jnext][K].ydisp ));
